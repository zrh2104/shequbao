...
public class ShopAdapter extends BaseAdapter {
	...
	public View getView(final int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			hold.mdistance=(TextView) arg1.findViewById(R.id.ShopItemJuli);
            hold.mintroduction=(TextView) arg1.findViewById(R.id.shopintroduction);
			arg1.setTag(hold);
		} else {
		...
		hold.mintroduction.setText(list.get(arg0).getSintroduction());
		if (list.get(arg0).getDistance()!=null) {
			hold.mdistance.setText(list.get(arg0).getDistance()+"km");
		}
	...
	static class Holder {
		TextView mTitle, mMoney, mAddress, mStytle,mintroduction,mdistance;
